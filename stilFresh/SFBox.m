...
- (id)init
{
    ...
    if (self) {
        ...
        _fontX = [UIFont fontWithName:@"AvenirNextCondensed-Regular" size:fontSizeM];
        _fontY = [UIFont fontWithName:@"HelveticaNeue-Bold" size:fontSizeM * 1.6];
        _fontQ = [UIFont fontWithName:@"GillSans-Light" size:fontSizeM * 0.8];
        _fontZ = [UIFont fontWithName:@"Futura-Medium" size:fontSizeM];
        _fontS = [UIFont fontWithName:@"GillSans-Light" size:fontSizeS];
        _fontM = [UIFont fontWithName:@"GillSans-Light" size:fontSizeM];
        _fontL = [UIFont fontWithName:@"GillSans-Light" size:fontSizeL];
        CGFloat alpha = 1;
        ...
        _darkText = [UIColor colorWithRed:99/255.0 green:99/255.0 blue:99/255.0 alpha:1];
        _milkWhite = [UIColor colorWithRed:249 / 255.0 green:249 / 255.0 blue:240 / 255.0 alpha:alpha];
